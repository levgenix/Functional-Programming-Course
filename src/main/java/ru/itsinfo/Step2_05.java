...
public class Step2_05 {
     ...
     * of all numbers in this range (inclusively).
     ...
     */
    public static BinaryOperator<Long> calculatingProductionOfAllNumbersInTheRangeFunction() {
        return (u, t) -> LongStream.rangeClosed(u, t).reduce(1L, (acc, x) -> acc * x);
    }
}
